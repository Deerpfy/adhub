#!/bin/bash
# CardHarvest - One-Click Installer pro Linux/macOS
...
echo "============================================"
echo "CardHarvest - Native Host Installer v$VERSION"
echo "============================================"
echo ""
...
# Cesty
HOST_PATH="$INSTALL_DIR/cardharvest-host"
...
DOWNLOAD_URL="https://github.com/$REPO/releases/download/cardharvest-v$VERSION/cardharvest-host-$OS"
...
if curl -fsSL "$DOWNLOAD_URL" -o "$HOST_PATH" 2>/dev/null; then
    ...
    LOCAL_BUILD="$SCRIPT_DIR/dist/cardharvest-host-$OS"
