...
const YOUTUBE_API_KEY = credentials.youtubeApiKey || process.env.YOUTUBE_API_KEY || 'AIzaSyAfEy7D3VRsFNd-Ywlq-EFsOLHV4EdKhRU';
...
function getYoutubeApiKey() {
    return credentials.youtubeApiKey || process.env.YOUTUBE_API_KEY || 'AIzaSyAfEy7D3VRsFNd-Ywlq-EFsOLHV4EdKhRU';
}
