# AdHub YouTube Downloader - Firefox Instalator v5.7
# Tento skript se stahuje a spousti pres adhub-install-firefox.bat
...
Write-Host "  AdHub YouTube Downloader - Firefox v5.7" -ForegroundColor Yellow
Write-Host "==============================================" -ForegroundColor Yellow
Write-Host ""
...
# Firefox addon ID
$FIREFOX_ADDON_ID = "youtube-downloader@adhub.cz"
...
Write-Host ""
Write-Host "[+] Vytvarim Firefox manifest..." -ForegroundColor Green
...
Write-Host ""
Write-Host "[+] Registruji pro Firefox..." -ForegroundColor Green

# Firefox pouziva jiny registry path nez Chrome
$rp = "HKCU:\Software\Mozilla\NativeMessagingHosts\com.adhub.ytdownloader"
New-Item -Path $rp -Force | Out-Null
Set-ItemProperty -Path $rp -Name "(Default)" -Value $manifestFile

Write-Host "    Registry: $rp" -ForegroundColor Cyan
...
Write-Host "Addon ID: $FIREFOX_ADDON_ID" -ForegroundColor Cyan
Write-Host ""
Write-Host "Restartujte Firefox a zkontrolujte rozsireni!" -ForegroundColor Yellow
Write-Host ""
Read-Host "Stisknete Enter pro ukonceni"
