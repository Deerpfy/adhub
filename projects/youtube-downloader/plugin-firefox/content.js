/**
 * AdHub YouTube Downloader v5.7 - Content Script (Firefox)
 *
...
(function() {
  ...
  if (window.__ADHUB_YT_DL_V57__) return;
  window.__ADHUB_YT_DL_V57__ = true;

  console.log('[AdHub] YouTube Downloader v5.7 (Firefox Hybrid)');
  ...
  async function checkAdvancedMode() {
    ...
    try {
      const response = await browserAPI.runtime.sendMessage({ action: 'checkNativeHost' });
