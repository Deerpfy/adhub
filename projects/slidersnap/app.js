/**
 * SliderSnap Offline - Before/After Image Comparison PWA
...
const EMBED_BASE_URL = 'https://deerpfy.github.io/adhub/projects/slidersnap-offline';
...
function initLanguage() {
    const savedLang = localStorage.getItem('slidersnap_lang') || 'cs';
...
function setLanguage(lang) {
    currentLang = lang;
    localStorage.setItem('slidersnap_lang', lang);
...
function renderSlider(before, after, options) {
    const container = document.getElementById('slidersnapContainer');
    container.innerHTML = '';
...
function downloadGif() {
    ...
    const link = document.createElement('a');
    link.download = 'slidersnap-animation.gif';
