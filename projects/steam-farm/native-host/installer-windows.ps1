# Steam Farm - One-Click Installer pro Windows
...
Write-Host "Steam Farm - Native Host Installer v$VERSION" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
$HostPath = "$InstallDir\steam-farm-host.exe"
...
$DownloadUrl = "https://github.com/$REPO/releases/download/steam-farm-v$VERSION/steam-farm-host-win.exe"
...
try {
    ...
    $LocalBuild = Join-Path $PSScriptRoot "dist\steam-farm-host-win.exe"
